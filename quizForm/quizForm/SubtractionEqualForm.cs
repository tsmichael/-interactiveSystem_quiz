...
namespace quizForm
{
    public partial class SubtractionEqualForm : Form
    {
        ...
        private String tableName = "SubtractionEqual";
        private int activeAnswer = 0;
        private int questionIndex;

        public SubtractionEqualForm()
        {
            InitializeComponent();
        }

        private void SubtractionEqualForm_Activated(object sender, EventArgs e)
        {
            label_anounce.Text = "Зроби свій вибір =) ";
            textBox_question.Text = "Знайди однакову відповідь до рівності ";
